...
//  addToDoItem("Test ToDo"); // This should add a new todo item to the array- 1
...
//  markToDoItemAsCompleted(0); // This should mark the todo item with ID 0 as completed - 2, run as clear completed